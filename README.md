...
**Currently learning:**
![AWS](https://img.shields.io/badge/AWS-lightgrey?style=flat-square&logo=amazonaws)
![Kubernetes](https://img.shields.io/badge/Kubernetes-lightgrey?style=flat-square&logo=kubernetes)
![GitOps](https://img.shields.io/badge/GitOps-lightgrey?style=flat-square&logo=argo)

## Featured Work

<details>
<summary><strong>mern-infra</strong> — Modular MERN monorepo with Docker and CI</summary>
...
<details>
<summary><strong>Node.js E-commerce API Boilerplate</strong> — Node.js + TypeScript e-commerce API boilerplate</summary>
...
<details>
<summary><strong>e-commerce-cms</strong> — MERN e-commerce CMS</summary>
...
```mermaid
graph LR
  A[Full Stack MERN + TypeScript] --> B[Docker and CI basics]
  B --> C[AWS Fundamentals - learning]
  C --> D[Kubernetes / EKS - planned]
  D --> E[GitOps and CI/CD Pipelines - planned]
  E --> F[Agentic AI Workflows - exploring]
```
...
## Contact
[![Email](https://img.shields.io/badge/Email-aliakbarlive14%40gmail.com-black?style=flat-square&logo=gmail)](mailto:aliakbarlive14@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-aliakbarlive-black?style=flat-square&logo=linkedin)](https://www.linkedin.com/in/aliakbarlive)
